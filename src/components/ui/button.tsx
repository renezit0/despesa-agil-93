  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success: "bg-success text-success-foreground hover:bg-success-hover transition-all duration-200",
        warning: "bg-warning text-warning-foreground hover:bg-warning-hover transition-all duration-200",
        gradient: "bg-gradient-to-r from-primary to-primary-hover text-primary-foreground hover:shadow-lg hover:scale-105 transition-all duration-200",
      },
      size: {
